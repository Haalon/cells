...
void main(){
    ...
    if(fin_0>=25.0&&fin_0<=80.0){
        outval=0.0;
    }
    if(fin_0>=65.0&&fin_0<=76.0){
        outval=0.0;
    }
    if(fin_0>=39.0&&fin_0<=43.0){
        outval=1.0;
    }
    if(fin_0>=84.0&&fin_0<=139.0){
        outval=1.0;
    }
    ...
    if(fin_2>=15.0&&fin_2<=29.0){
        outval=0.0;
    }
    if(fin_2>=59.0&&fin_2<=62.0){
        outval=1.0;
    }
