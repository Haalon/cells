...
void main(){
    ...
    if(fin_0>=66.0&&fin_0<=68.0){
        outval=1.0;
    }
    if(fin_0>=104.0&&fin_0<=150.0){
        outval=1.0;
    }
    if(fin_0>=114.0&&fin_0<=170.0){
        outval=1.0;
    }
    if(fin_0>=0.0&&fin_0<=25.0){
        outval=0.0;
    }
    if(fin_0>=81.0&&fin_0<=104.0){
        outval=0.0;
    }
    if(fin_0>=88.0&&fin_0<=92.0){
        outval=0.0;
    }
    if(fin_0>=95.0&&fin_0<=104.0){
        outval=0.0;
    }
