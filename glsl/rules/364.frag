...
void main(){
    ...
    if(fin_0>=42.0&&fin_0<=55.0){
        outval=0.0;
    }
    if(fin_0>=77.0&&fin_0<=81.0){
        outval=1.0;
    }
    if(fin_0>=39.0&&fin_0<=41.0){
        outval=1.0;
    }
    if(fin_0>=70.0&&fin_0<=139.0){
        outval=1.0;
    }
    if(fin_1>=2.0&&fin_1<=2.0){
        outval=0.0;
    }
    if(fin_1>=11.0&&fin_1<=22.0){
        outval=1.0;
    }
    if(fin_2>=12.0&&fin_2<=32.0){
        outval=0.0;
    }
    if(fin_2>=73.0){
        outval=0.0;
