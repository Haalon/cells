...
void main(){
    ...
    if(fin_0>=35.0&&fin_0<=39.0){
        outval=1.0;
    }
    if(fin_1>=7.0&&fin_1<=11.0){
        outval=1.0;
    }
    if(fin_1>=12.0&&fin_1<=12.0){
        outval=0.0;
    }
    if(fin_2>=0.0&&fin_2<=23.0){
        outval=0.0;
    }
    if(fin_2>=35.0&&fin_2<=37.0){
        outval=1.0;
    }
    if(fin_2>=69.0){
        outval=0.0;
    }
    if(fin_3>=62.0&&fin_3<=114.0){
        outval=0.0;
    }
    if(fin_3>=71.0&&fin_3<=78.0){
        outval=1.0;
    }
    if(fin_3>=89.0&&fin_3<=90.0){
        outval=1.0;
    }
    if(fin_3>=169.0&&fin_3<=187.0){
        outval=1.0;
    }
    if(fin_3>=190.0){
        outval=0.0;
