...
void main(){
    ...
    float fin_0=nhd0;
    if(fin_0>=10.0&&fin_0<=16.0){
        outval=1.0;
    }
    if(fin_0>=17.0&&fin_0<=24.0){
        outval=0.0;
    }
    ...
    if(fin_1>=15.0&&fin_1<=19.0){
        outval=1.0;
    }
    if(fin_1>=63.0&&fin_1<=78.0){
        outval=0.0;
    }
    if(fin_1>=16.0&&fin_1<=22.0){
        outval=0.0;
    }
    if(fin_1>=59.0&&fin_1<=59.0){
        outval=1.0;
    }
    if(fin_1>=87.0&&fin_1<=157.0){
        outval=1.0;
    }
