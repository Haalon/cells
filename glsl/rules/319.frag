...
void main(){
    ...
    if(fin_0>39.0&&fin_0<46.0){
        outval=0.0;
    }
    if(fin_0>=19.0&&fin_0<=24.0){
        outval=0.0;
    }
    ...
    if(fin_1>=240.0&&fin_1<=275.0){
        outval=1.0;
    }
    if(fin_1>=78.0&&fin_1<=80.0){
        outval=1.0;
    }
    if(fin_1>=55.0&&fin_1<=59.0){
        outval=1.0;
    }
    if(fin_1>=39.0&&fin_1<=39.0){
        outval=1.0;
    }
    if(fin_1>=19.0&&fin_1<=19.0){
        outval=1.0;
    }
