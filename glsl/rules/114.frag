...
void main(){
    ...
    if(fin_1>=40.0&&fin_1<=43.0){
        outval=1.0;
    }
    if(fin_1>=93.0&&fin_1<=155.0){
        outval=1.0;
    }
    float nhd10=cv(-3.0,-1.0)+cv(-3.0,0.0)+cv(-3.0,1.0)+cv(-2.0,-2.0)+cv(-2.0,2.0)+cv(-1.0,-3.0)+cv(-1.0,-1.0)+cv(-1.0,0.0)+cv(-1.0,1.0)+cv(-1.0,3.0)+cv(0.0,-3.0)+cv(0.0,-1.0)+cv(0.0,1.0)+cv(0.0,3.0)+cv(1.0,-3.0)+cv(1.0,-1.0)+cv(1.0,0.0)+cv(1.0,1.0)+cv(1.0,3.0)+cv(2.0,-2.0)+cv(2.0,2.0)+cv(3.0,-1.0)+cv(3.0,0.0)+cv(3.0,1.0);
    float fin_2=nhd10;
    if(fin_2>=12.0&&fin_2<=19.0){
        outval=1.0;
    }
    if(fin_2>=15.0&&fin_2<=17.0){
        outval=1.0;
    }
