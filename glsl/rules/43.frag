...
void main(){
    ...
    float nhd0=cv(1.0,-1.0)+cv(1.0,0.0)+cv(1.0,1.0)+cv(-1.0,-1.0)+cv(-1.0,0.0)+cv(-1.0,1.0)+cv(0.0,-1.0)+cv(0.0,1.0);
    float fin_0=nhd0;
    if(fin_0>=4.0){
        outval=0.0;
    }
    ...
    float fin_4=nhd5+nhd6;
    if(fin_1>=85.0&&fin_1<=145.0){
        outval=1.0;
    }
    if(fin_1>=40.0&&fin_1<=49.0){
        outval=0.0;
    }
    ...
    if(fin_1>=121.0&&fin_1<=121.0){
        outval=0.0;
    }
    if(fin_1>=210.0&&fin_1<=295.0){
        outval=1.0;
    }
