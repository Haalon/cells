...
void main(){
    ...
    if(fin_0>=41.0&&fin_0<=43.0){
        outval=1.0;
    }
    if(fin_0>=79.0&&fin_0<=86.0){
        outval=1.0;
    }
    if(fin_0>=119.0&&fin_0<=985.0){
        outval=1.0;
    }
    ...
    if(fin_2>=209.0&&fin_2<=340.0){
        outval=1.0;
    }
    if(fin_2>=249.0&&fin_2<=330.0){
        outval=1.0;
    }
    if(fin_2>=299.0&&fin_2<=320.0){
        outval=1.0;
    }
