...
void main(){
    ...
    if(fin_0>=5.0&&fin_0<=5.0){
        outval=0.0;
    }
    if(fin_1>=37.0&&fin_1<=43.0){
        outval=0.0;
    }
    if(fin_1>=77.0&&fin_1<=89.0){
        outval=1.0;
    }
    if(fin_1>=46.0&&fin_1<=46.0){
        outval=1.0;
    }
    if(fin_1>=33.0&&fin_1<=33.0){
        outval=1.0;
    }
    if(fin_1>=121.0&&fin_1<=126.0){
        outval=1.0;
    }
    if(fin_1>=39.0&&fin_1<=76.0){
        outval=0.0;
    }
    if(fin_1>=137.0&&fin_1<=182.0){
        outval=0.0;
    }
    if(fin_1>=153.0){
        outval=0.0;
    }
    if(fin_1>=153.0&&fin_1<=172.0){
        outval=1.0;
    }
