...
void main(){
    ...
    if(fin_1>=9.0&&fin_1<=24.0){
        outval=0.0;
    }
    if(fin_1>=45.0&&fin_1<=55.0){
        outval=1.0;
    }
    if(fin_1>=61.0){
        outval=0.0;
    }
    if(fin_2>=82.0&&fin_2<=115.0){
        outval=0.0;
    }
    if(fin_2>=88.0&&fin_2<=91.0){
        outval=1.0;
    }
    if(fin_2>=169.0&&fin_2<=187.0){
        outval=1.0;
    }
    if(fin_2>=193.0){
        outval=0.0;
    }
    if(fin_3>=19.0&&fin_3<=19.0){
        outval=1.0;
    }
    if(fin_3>=22.0&&fin_3<=27.0){
        outval=0.0;
    }
