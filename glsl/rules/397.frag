...
void main(){
    ...
    float fin_0=nhd0;
    //outval=0.0;
    if(fin_0>=22.0&&fin_0<=36.0){
        outval=1.0;
    }
    if(fin_0==7.0){
        outval=1.0;
    }
    float nhd1=cv(-2.0,-1.0)+cv(-2.0,0.0)+cv(-2.0,1.0)+cv(-1.0,-2.0)+cv(-1.0,-1.0)+cv(-1.0,0.0)+cv(-1.0,1.0)+cv(-1.0,2.0)+cv(0.0,-2.0)+cv(0.0,-1.0)+cv(0.0,1.0)+cv(0.0,2.0)+cv(1.0,-2.0)+cv(1.0,-1.0)+cv(1.0,0.0)+cv(1.0,1.0)+cv(1.0,2.0)+cv(2.0,-1.0)+cv(2.0,0.0)+cv(2.0,1.0);
    float fin_1=nhd1;
