...
void main(){
    ...
    if(fin_0>=20.0&&fin_0<=24.0){
        outval=1.0;
    }
    if(fin_0>=51.0&&fin_0<=100.0){
        outval=1.0;
    }
    if(fin_0>=24.0&&fin_0<=58.0){
        outval=0.0;
    }
