...
void main(){
    ...
    float fin_0=nhd0;
    if(fin_0>=11.0&&fin_0<=13.0){
        outval=1.0;
    }
    if(fin_0>=14.0&&fin_0<=14.0){
        outval=1.0;
    }
    if(fin_0>=15.0&&fin_0<=15.0){
        outval=1.0;
    }
    if(fin_0>=16.0&&fin_0<=16.0){
        outval=1.0;
    }
    if(fin_0>=17.0){
        outval=0.0;
    ...
    if(fin_1>=16.0&&fin_1<=19.0){
        outval=1.0;
    }
    if(fin_1>=63.0&&fin_1<=80.0){
        outval=0.0;
    }
    if(fin_1>=16.0&&fin_1<=20.0){
        outval=0.0;
    }
    if(fin_1>=57.0&&fin_1<=57.0){
        outval=1.0;
    }
    if(fin_1>=42.0&&fin_1<=43.0){
        outval=1.0;
    }
    if(fin_1>=81.0&&fin_1<=127.0){
        outval=1.0;
    }
