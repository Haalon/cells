...
void main(){
    ...
    if(fin_0>=0.0&&fin_0<=8.0){
        outval=0.0;
    }
    if(fin_0>=31.0&&fin_0<=80.0){
        outval=0.0;
    }
    if(fin_0>=65.0&&fin_0<=76.0){
        outval=0.0;
    }
    if(fin_0>=39.0&&fin_0<=44.0){
        outval=1.0;
    }
    if(fin_0>=88.0&&fin_0<=139.0){
        outval=1.0;
    }
    if(fin_1>=12.0&&fin_1<=27.0){
        outval=1.0;
    }
    if(fin_2>=12.0&&fin_2<=24.0){
        outval=0.0;
    }
    if(fin_3>=161.0&&fin_3<=188.0){
        outval=0.0;
    }
    if(fin_3>=287.0){
        outval=0.0;
