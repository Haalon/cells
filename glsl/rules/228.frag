...
void main(){
    ...
    if(fin_1>=69.0&&fin_1<=69.0){
        outval=1.0;
    }
    if(fin_1>=33.0&&fin_1<=33.0){
        outval=1.0;
    }
    if(fin_1>=133.0&&fin_1<=169.0){
        outval=1.0;
    }
    if(fin_1>=139.0&&fin_1<=149.0){
        outval=1.0;
    }
    if(fin_1>=76.0&&fin_1<=76.0){
        outval=0.0;
    }
    if(fin_1>=41.0&&fin_1<=51.0){
        outval=0.0;
    }
    if(fin_1>=175.0&&fin_1<=210.0){
        outval=0.0;
    }
    if(fin_1>=143.0&&fin_1<=150.0){
        outval=0.0;
    }
    if(fin_1>=250.0){
        outval=0.0;
