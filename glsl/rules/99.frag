...
void main(){
    ...
    float fin_2=nhd2;
    if(fin_2>=7.0&&fin_2<=12.0){
        outval=0.0;
    }
    if(fin_2>=13.0&&fin_2<=14.0){
        outval=1.0;
    }
    if(fin_2>=32.0&&fin_2<=40.0){
        outval=0.0;
    }
    ...
    float fin_3=nhd3+nhd4+nhd5+nhd6;
    if(fin_3>=89.0&&fin_3<=92.0){
        outval=1.0;
    }
    if(fin_3>=112.0&&fin_3<=170.0){
        outval=1.0;
    }
    if(fin_3>=135.0&&fin_3<=140.0){
        outval=1.0;
    }
    if(fin_3>=96.0&&fin_3<=100.0){
        outval=0.0;
    }
