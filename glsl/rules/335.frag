...
void main(){
    ...
    if(fin_0>=0.0&&fin_0<=41.0){
        outval=0.0;
    }
    if(fin_0>=110.0&&fin_0<=130.0){
        outval=0.0;
    }
    if(fin_0>=30.0&&fin_0<=33.0){
        outval=1.0;
    }
    if(fin_0>=87.0&&fin_0<=109.0){
        outval=1.0;
    }
    if(fin_1>=12.0&&fin_1<=992.0){
        outval=1.0;
    }
    if(fin_2>=11.0&&fin_2<=32.0){
        outval=0.0;
    }
    if(fin_3>=61.0&&fin_3<=62.0){
        outval=0.0;
    }
    if(fin_3>=155.0&&fin_3<=185.0){
        outval=0.0;
    }
    if(fin_3>=300.0){
        outval=0.0;
